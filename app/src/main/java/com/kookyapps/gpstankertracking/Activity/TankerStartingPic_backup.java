...
public class TankerStartingPic_backup extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ib_tnkr_strt_capture:
                ...
                SharedPrefUtil.setPreferences(TankerStartingPic_backup.this,Constants.SHARED_PREF_IMAGE_TAG,Constants.SHARED_END_IMAGE_KEY,imageencoded);
                captureImgBtn.setClickable(false);
                if (init_type!=null){
                i= new Intent(TankerStartingPic_backup.this,EnterOTP.class);
                ...
                if(grantResults.length>0){
                    ...
                    if(permissionGranted){
                       ...
                       // buildGoogleApiClient();
                        ...
                        checkAndRequestPermissions(TankerStartingPic_backup.this,allpermissionsrequired);
                    }
                }
        }
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST,url
                        ...
                        try {
                            ...
                            if(obj!=null){
                                if(obj.getInt("error")==0){
                                    ...
                                    SharedPrefUtil.setPreferences(TankerStartingPic_backup.this,Constants.SHARED_PREF_ONGOING_TAG,Constants.SHARED_ONGOING_BOOKING_ID,blmod.getBookingid());
                                    SharedPrefUtil.setPreferences(TankerStartingPic_backup.this,Constants.SHARED_PREF_ONGOING_TAG,Constants.SHARED_ONGOING_DRIVER_ID,SessionManagement.getUserId(TankerStartingPic_backup.this));
                                    Toast.makeText(getApplicationContext(), obj.getString("message"), Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(TankerStartingPic_backup.this,Map1.class);
                                    ...
                                    RequestQueueService.showAlert(obj.getString("message"), TankerStartingPic_backup.this);
                                    captureImgBtn.setClickable(true);
                                    progressBar.setVisibility(View.GONE);
                                    //requestLayout.setBackgroundResource(R.drawable.straight_corners);
                                }
                            }else{
                                RequestQueueService.showAlert("Error! No data fetched", TankerStartingPic_backup.this);
                                captureImgBtn.setClickable(true);
                                progressBar.setVisibility(View.GONE);
                                //requestLayout.setBackgroundResource(R.drawable.straight_corners);
                            }
                        } catch (JSONException e) {
                            RequestQueueService.showAlert("Something went wrong", TankerStartingPic_backup.this);
           ...
           /* @Override
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                params.put("Authorization", "Bearer "+SessionManagement.getUserToken(TankerStartingPic_backup.this));
                return params;
            }
