...
public class TripDetailsModal {
    ...
    public String getTotaltrip() { return totaltrip;}
    public void setTotaltrip(String totaltrip) { this.totaltrip = totaltrip; }
    public String getTotal_distance() { return total_distance; }
    public void setTotal_distance(String total_distance) { this.total_distance = total_distance; }
